...
#绘制折线图1
plt.plot(values[:,0],values[:,3],color = 'r',linestyle = '--',marker = 'o')
#绘制折线图2
plt.plot(values[:,0],values[:,4],color = 'y',linestyle = '-',marker = 'D')
#绘制折线图3
plt.plot(values[:,0],values[:,5],color = 'k',linestyle = '-.',marker = 'v')
